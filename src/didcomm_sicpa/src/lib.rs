// Vendored upstream code (edition-2018 era). Silence a few newer rustc lints
// that a strict `-D warnings` build would otherwise reject; we keep the source
// close to upstream and optimize hot paths rather than churn lint fixes.
